...
export function TeamBadge({ code, rank, group, size = "md" }: TeamBadgeProps) {
  ...
  return (
    <span
      ...
      className={`team-badge inline-flex shrink-0 items-center justify-center overflow-hidden rounded-full border ${SIZE_CLASS[size]} ${ring} ${
        isTbd
